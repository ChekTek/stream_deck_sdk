class WillDisappearEvent {
  ...
  WillDisappearEvent({this.action, this.context, this.device, this.event, this.payload});

  WillDisappearEvent.fromJson(Map<String, dynamic> json) {
    action = json['action'];
